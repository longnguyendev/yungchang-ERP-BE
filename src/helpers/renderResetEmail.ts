export function renderResetEmail(resetLink: string) {
  return `<!DOCTYPE HTML
...
<body class="clean-body u_body"
  style="margin: 0;padding: 40px 0;-webkit-text-size-adjust: 100%;background-color: #F7F8F9;color: #000000">
                                ...
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0"
                                      src="https://res.cloudinary.com/djfdnvhrr/image/upload/v1734681430/logo-full_eww7mc.png"
                                      alt="" title=""
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <h1
                                style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 44px; font-weight: 700;">
                                <span>Đặt lại mật khẩu</span></h1>
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="line-height: 140%; margin: 0px;"><span
                                    style="font-size: 20px; line-height: 28px;">Nhấp vào liên kết sau để đặt lại mật
                                    khẩu của bạn</span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <!--[if mso]><table width="100%"><tr><td><![endif]-->
                              <h1
                                style="margin: 0px; color: #000000; line-height: 100%; text-align: center; word-wrap: break-word; font-family: inherit; letter-spacing: 0px; font-size: 34px; font-weight: 700;">
                                <span><a rel="noopener" href="${resetLink}" target="_blank"
                                    style="color: rgb(0, 0, 238); text-decoration: underline; line-height: inherit;">&gt;&gt;đặt
                                    lại mật khẩu&lt;&lt;</a></span></h1>
                              <!--[if mso]></td></tr></table><![endif]-->
                          ...
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%; text-align: center; margin: 0px;"><span
                                    style="font-size: 20px; line-height: 28px;">Lưu ý liên kết có hiệu lực trong vòng 10
                                    phút</span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%; text-align: center; margin: 0px;"><span
                                    style="color: #7e8c8d; line-height: 19.6px;">Nếu bạn không gửi mail này!, bạn có thể
                                    bỏ qua.</span></p>
                              </div>
